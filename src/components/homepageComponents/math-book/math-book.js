...
import '../math-book/math-book.scss'
import Pagination from '../pagination/pagination'
class MathBook extends Component {
    render() {
        return (
            <div className = "section-vn-book">
                <div className="section-vn-book-title">
					<h3><span>Sách toán học</span></h3>
				</div>
                <div className = "section-vn-book-content container">
                    <div className="row">
